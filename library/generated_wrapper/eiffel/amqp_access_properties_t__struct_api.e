...
class AMQP_ACCESS_PROPERTIES_T__STRUCT_API
...
feature {NONE} -- Implementation wrapper for struct struct amqp_access_properties_t_

	sizeof_external: INTEGER 
		external
			"C inline use <amqp.h>"
		alias
			"sizeof(struct amqp_access_properties_t_)"
		end
	...
	c_flags (an_item: POINTER): NATURAL
		...
		alias
			"[
				((struct amqp_access_properties_t_*)$an_item)->_flags
			]"
		end
	...
	set_c_flags (an_item: POINTER; a_value: NATURAL) 
		...
		alias
			"[
				((struct amqp_access_properties_t_*)$an_item)->_flags =  (amqp_flags_t)$a_value
			]"
		ensure
	...
	c_dummy (an_item: POINTER): CHARACTER
		...
		alias
			"[
				((struct amqp_access_properties_t_*)$an_item)->dummy
			]"
		end
	...
	set_c_dummy (an_item: POINTER; a_value: CHARACTER) 
		...
		alias
			"[
				((struct amqp_access_properties_t_*)$an_item)->dummy =  (char)$a_value
			]"
		ensure
