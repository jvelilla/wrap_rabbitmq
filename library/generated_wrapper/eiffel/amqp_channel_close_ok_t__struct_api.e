...
class AMQP_CHANNEL_CLOSE_OK_T__STRUCT_API
...
feature {NONE} -- Implementation wrapper for struct struct amqp_channel_close_ok_t_

	sizeof_external: INTEGER 
		external
			"C inline use <amqp.h>"
		alias
			"sizeof(struct amqp_channel_close_ok_t_)"
		end
	...
	c_dummy (an_item: POINTER): CHARACTER
		...
		alias
			"[
				((struct amqp_channel_close_ok_t_*)$an_item)->dummy
			]"
		end
	...
	set_c_dummy (an_item: POINTER; a_value: CHARACTER) 
		...
		alias
			"[
				((struct amqp_channel_close_ok_t_*)$an_item)->dummy =  (char)$a_value
			]"
		ensure
