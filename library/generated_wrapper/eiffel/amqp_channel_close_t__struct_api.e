...
class AMQP_CHANNEL_CLOSE_T__STRUCT_API
...
feature {NONE} -- Implementation wrapper for struct struct amqp_channel_close_t_

	sizeof_external: INTEGER 
		external
			"C inline use <amqp.h>"
		alias
			"sizeof(struct amqp_channel_close_t_)"
		end
	...
	c_reply_code (an_item: POINTER): NATURAL
		...
		alias
			"[
				((struct amqp_channel_close_t_*)$an_item)->reply_code
			]"
		end
	...
	set_c_reply_code (an_item: POINTER; a_value: NATURAL) 
		...
		alias
			"[
				((struct amqp_channel_close_t_*)$an_item)->reply_code =  (uint16_t)$a_value
			]"
		ensure
	...
	c_reply_text (an_item: POINTER): POINTER
		...
		alias
			"[
				&((struct amqp_channel_close_t_*)$an_item)->reply_text
			]"
		end
	...
	set_c_reply_text (an_item: POINTER; a_value: POINTER) 
		...
		alias
			"[
				((struct amqp_channel_close_t_*)$an_item)->reply_text =  *(amqp_bytes_t*)$a_value
			]"
		end
	...
	c_class_id (an_item: POINTER): NATURAL
		...
		alias
			"[
				((struct amqp_channel_close_t_*)$an_item)->class_id
			]"
		end
	...
	set_c_class_id (an_item: POINTER; a_value: NATURAL) 
		...
		alias
			"[
				((struct amqp_channel_close_t_*)$an_item)->class_id =  (uint16_t)$a_value
			]"
		ensure
	...
	c_method_id (an_item: POINTER): NATURAL
		...
		alias
			"[
				((struct amqp_channel_close_t_*)$an_item)->method_id
			]"
		end
	...
	set_c_method_id (an_item: POINTER; a_value: NATURAL) 
		...
		alias
			"[
				((struct amqp_channel_close_t_*)$an_item)->method_id =  (uint16_t)$a_value
			]"
		ensure
