...
class AMQP_CHANNEL_FLOW_T__STRUCT_API
...
feature {NONE} -- Implementation wrapper for struct struct amqp_channel_flow_t_

	sizeof_external: INTEGER 
		external
			"C inline use <amqp.h>"
		alias
			"sizeof(struct amqp_channel_flow_t_)"
		end
	...
	c_active (an_item: POINTER): INTEGER
		...
		alias
			"[
				((struct amqp_channel_flow_t_*)$an_item)->active
			]"
		end
	...
	set_c_active (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((struct amqp_channel_flow_t_*)$an_item)->active =  (amqp_boolean_t)$a_value
			]"
		ensure
