...
class AMQP_EXCHANGE_BIND_T__STRUCT_API
...
feature {NONE} -- Implementation wrapper for struct struct amqp_exchange_bind_t_

	sizeof_external: INTEGER 
		external
			"C inline use <amqp.h>"
		alias
			"sizeof(struct amqp_exchange_bind_t_)"
		end
	...
	c_ticket (an_item: POINTER): NATURAL
		...
		alias
			"[
				((struct amqp_exchange_bind_t_*)$an_item)->ticket
			]"
		end
	...
	set_c_ticket (an_item: POINTER; a_value: NATURAL) 
		...
		alias
			"[
				((struct amqp_exchange_bind_t_*)$an_item)->ticket =  (uint16_t)$a_value
			]"
		ensure
	...
	c_destination (an_item: POINTER): POINTER
		...
		alias
			"[
				&((struct amqp_exchange_bind_t_*)$an_item)->destination
			]"
		end
	...
	set_c_destination (an_item: POINTER; a_value: POINTER) 
		...
		alias
			"[
				((struct amqp_exchange_bind_t_*)$an_item)->destination =  *(amqp_bytes_t*)$a_value
			]"
		end
	...
	c_source (an_item: POINTER): POINTER
		...
		alias
			"[
				&((struct amqp_exchange_bind_t_*)$an_item)->source
			]"
		end
	...
	set_c_source (an_item: POINTER; a_value: POINTER) 
		...
		alias
			"[
				((struct amqp_exchange_bind_t_*)$an_item)->source =  *(amqp_bytes_t*)$a_value
			]"
		end
	...
	c_routing_key (an_item: POINTER): POINTER
		...
		alias
			"[
				&((struct amqp_exchange_bind_t_*)$an_item)->routing_key
			]"
		end
	...
	set_c_routing_key (an_item: POINTER; a_value: POINTER) 
		...
		alias
			"[
				((struct amqp_exchange_bind_t_*)$an_item)->routing_key =  *(amqp_bytes_t*)$a_value
			]"
		end
	...
	c_nowait (an_item: POINTER): INTEGER
		...
		alias
			"[
				((struct amqp_exchange_bind_t_*)$an_item)->nowait
			]"
		end
	...
	set_c_nowait (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((struct amqp_exchange_bind_t_*)$an_item)->nowait =  (amqp_boolean_t)$a_value
			]"
		ensure
	...
	c_arguments (an_item: POINTER): POINTER
		...
		alias
			"[
				&((struct amqp_exchange_bind_t_*)$an_item)->arguments
			]"
		end
	...
	set_c_arguments (an_item: POINTER; a_value: POINTER) 
		...
		alias
			"[
				((struct amqp_exchange_bind_t_*)$an_item)->arguments =  *(amqp_table_t*)$a_value
			]"
		end
