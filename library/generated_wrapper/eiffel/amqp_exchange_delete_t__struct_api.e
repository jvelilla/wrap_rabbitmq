...
class AMQP_EXCHANGE_DELETE_T__STRUCT_API
...
feature {NONE} -- Implementation wrapper for struct struct amqp_exchange_delete_t_

	sizeof_external: INTEGER 
		external
			"C inline use <amqp.h>"
		alias
			"sizeof(struct amqp_exchange_delete_t_)"
		end
	...
	c_ticket (an_item: POINTER): NATURAL
		...
		alias
			"[
				((struct amqp_exchange_delete_t_*)$an_item)->ticket
			]"
		end
	...
	set_c_ticket (an_item: POINTER; a_value: NATURAL) 
		...
		alias
			"[
				((struct amqp_exchange_delete_t_*)$an_item)->ticket =  (uint16_t)$a_value
			]"
		ensure
	...
	c_exchange (an_item: POINTER): POINTER
		...
		alias
			"[
				&((struct amqp_exchange_delete_t_*)$an_item)->exchange
			]"
		end
	...
	set_c_exchange (an_item: POINTER; a_value: POINTER) 
		...
		alias
			"[
				((struct amqp_exchange_delete_t_*)$an_item)->exchange =  *(amqp_bytes_t*)$a_value
			]"
		end
	...
	c_if_unused (an_item: POINTER): INTEGER
		...
		alias
			"[
				((struct amqp_exchange_delete_t_*)$an_item)->if_unused
			]"
		end
	...
	set_c_if_unused (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((struct amqp_exchange_delete_t_*)$an_item)->if_unused =  (amqp_boolean_t)$a_value
			]"
		ensure
	...
	c_nowait (an_item: POINTER): INTEGER
		...
		alias
			"[
				((struct amqp_exchange_delete_t_*)$an_item)->nowait
			]"
		end
	...
	set_c_nowait (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((struct amqp_exchange_delete_t_*)$an_item)->nowait =  (amqp_boolean_t)$a_value
			]"
		ensure
