...
class AMQP_QUEUE_BIND_OK_T__STRUCT_API
...
feature {NONE} -- Implementation wrapper for struct struct amqp_queue_bind_ok_t_
	...
	c_dummy (an_item: POINTER): CHARACTER
		...
		alias
			"[
				((struct amqp_queue_bind_ok_t_*)$an_item)->dummy
			]"
		end
	...
	set_c_dummy (an_item: POINTER; a_value: CHARACTER) 
		...
		alias
			"[
				((struct amqp_queue_bind_ok_t_*)$an_item)->dummy =  (char)$a_value
			]"
		ensure
