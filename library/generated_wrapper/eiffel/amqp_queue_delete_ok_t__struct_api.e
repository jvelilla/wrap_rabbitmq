...
class AMQP_QUEUE_DELETE_OK_T__STRUCT_API
...
feature {NONE} -- Implementation wrapper for struct struct amqp_queue_delete_ok_t_

	sizeof_external: INTEGER 
		external
			"C inline use <amqp.h>"
		alias
			"sizeof(struct amqp_queue_delete_ok_t_)"
		end
	...
	c_message_count (an_item: POINTER): NATURAL
		...
		alias
			"[
				((struct amqp_queue_delete_ok_t_*)$an_item)->message_count
			]"
		end
	...
	set_c_message_count (an_item: POINTER; a_value: NATURAL) 
		...
		alias
			"[
				((struct amqp_queue_delete_ok_t_*)$an_item)->message_count =  (uint32_t)$a_value
			]"
		ensure
