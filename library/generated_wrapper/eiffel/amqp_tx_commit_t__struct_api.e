...
class AMQP_TX_COMMIT_T__STRUCT_API
...
feature {NONE} -- Implementation wrapper for struct struct amqp_tx_commit_t_

	sizeof_external: INTEGER 
		external
			"C inline use <amqp.h>"
		alias
			"sizeof(struct amqp_tx_commit_t_)"
		end
	...
	c_dummy (an_item: POINTER): CHARACTER
		...
		alias
			"[
				((struct amqp_tx_commit_t_*)$an_item)->dummy
			]"
		end
	...
	set_c_dummy (an_item: POINTER; a_value: CHARACTER) 
		...
		alias
			"[
				((struct amqp_tx_commit_t_*)$an_item)->dummy =  (char)$a_value
			]"
		ensure
